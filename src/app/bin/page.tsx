import { columns, type Files, type Folders } from "../bin/columns"
...
import { DataTableBin } from "~/components/data-table-bin";
...
export default async function DemoPage() {
  ...
  const data = await QUERIES.getFoldersAndFilesForBinPageByUserId(userId);
  ...
  return (
    ...
    >
      ...
      <SidebarInset>
        <SiteHeader pageCategory="Bin"/>
        <div className="flex flex-1 flex-col">
          <div className="@container/main flex flex-1 flex-col gap-2">
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
              <DataTableBin columns={columns} data={data} />
            </div>
          </div>
        </div>
      </SidebarInset>
